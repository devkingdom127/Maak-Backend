...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = os.getenv('SQLALCHEMY_DATABASE_URI_DEV', 'sqlite:///dev.sqlite')
...
class TestingConfig(Config):
    ...
    TESTING = True
    SQLALCHEMY_TRACK_MODIFICATIONS = False
    SQLALCHEMY_DATABASE_URI = os.getenv('SQLALCHEMY_DATABASE_URI_TESTING', 'sqlite:///test.sqlite')
